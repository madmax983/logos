    ...
    let id = store
        .write_transaction(
            TransactionBuilder::new("paycheck")
                .posting(Posting::debit(AccountId::new("assets:checking").unwrap(), 10_000))
    ...
    let txn_id = store
        .write_transaction(
            TransactionBuilder::new("txn1")
                .posting(Posting::debit(AccountId::new("assets:checking").unwrap(), 100))
    ...
    store
        .write_transaction(
            TransactionBuilder::new("txn2")
                .posting(Posting::debit(AccountId::new("assets:checking").unwrap(), 200))
        ...
        txn_id = store
            .write_transaction(
                TransactionBuilder::new("coffee")
                    .posting(Posting::debit(AccountId::new("expenses:food").unwrap(), 500))
                    .posting(Posting::credit(AccountId::new("assets:checking").unwrap(), 500).expect("credit")),
            )
            .expect("write txn");
        ...
        let txn_b = store
            .write_transaction(
                TransactionBuilder::new("groceries")
                    .posting(Posting::debit(AccountId::new("expenses:food").unwrap(), 2_500))
                    .posting(Posting::credit(AccountId::new("assets:checking").unwrap(), 2_500).expect("credit")),
            )
            .expect("txn b");
        store
            .write_reconciliation_run(
        ...
        store
            .write_transaction_with_valid_time(
                TransactionBuilder::new("backdated")
                    .posting(Posting::debit(AccountId::new("assets:checking").unwrap(), 7_500))
                    .posting(Posting::credit(AccountId::new("income:salary").unwrap(), 7_500).expect("credit")),
...
fn write_reconciliation_run_fails_with_negative_values() {
    ...
    let txn_id = store
        .write_transaction(
            TransactionBuilder::new("paycheck")
                .posting(Posting::debit(AccountId::new("assets:checking").unwrap(), 10_000))
                .posting(Posting::credit(AccountId::new("income:salary").unwrap(), 10_000).unwrap()),
        )
        .expect("write txn");
