...
impl MonteCarloProjector {
    ...
    pub fn run(&self, months: u16, paths: u32) -> MonteCarloResult {
        ...
        for _ in 0..paths {
            final_outcomes.push(self.simulate_path(months, monthly_mean, monthly_volatility, &mut lcg));
        }
    ...
    fn simulate_path(&self, months: u16, monthly_mean: f64, monthly_volatility: f64, lcg: &mut Lcg) -> i64 {
