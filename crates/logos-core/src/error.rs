...
pub enum DomainError {
    ...
    /// must perfectly cancel each other out to `0`.
    UnbalancedTransaction {
        /// How far off balance the transaction is.
        total: i64,
    },
