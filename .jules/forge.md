...
**Refactoring `logos-core` DebtOptimizer Simulate**
**Learning:** The `simulate` function in `DebtOptimizer` was a "God Function" exceeding 60 lines, mixing multiple concerns: interest calculation, minimum payments, strategy sorting, and extra payments.
**Action:** Extracted these distinct steps into small, descriptive, private helper functions (`apply_interest`, `pay_minimums`, `sort_debts_for_strategy`, `pay_extra`) to flatten the loop and improve readability.
