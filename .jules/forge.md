...
**Refactoring God Functions in FireAscentSimulator**
**Learning:** Functions like `ascend` contained complex logic to compute and build milestone milestones along with early exit logic. This made the function overly long and harder to read.
**Action:** The milestone calculation was extracted into a helper function `calculate_milestones`.
