...
**Refactoring God Modules like `args.rs`**
**Learning:** `crates/logos-cli/src/args.rs` was a massive 1300+ line file holding enums, models, business logic for command routing, and pure string parsing functions.
**Action:** Splitting `args.rs` into `args/mod.rs`, `args/model.rs`, and `args/parser.rs` correctly decoupled parsing implementation details from the domain definitions for CLI args.
